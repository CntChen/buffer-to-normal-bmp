...
class BufferToNormalBmp {
  constructor(bgraBuffer, width, height) {
    ...
    this.bgraBuffer = (BgraBufferBitTransform['from'+inputPixelBit+'To32']
      && BgraBufferBitTransform['from'+inputPixelBit+'To32'](bgraBuffer))
   ...
   */
  static reverseBufferLine(bgraBuffer, width, height) {
  ...
  to32bitBmpBuffer(bgraBuffer, pixelWidth, pixelHeight) {
    ...
    const bmpPixelBuffer = BufferToNormalBmp.reverseBufferLine(bgraBuffer, width, height);
  ...
  to24bitBmpBuffer(bgraBuffer, pixelWidth, pixelHeight) {
    ...
    const bmpPixelBuffer = BufferToNormalBmp.reverseBufferLine(bgraBuffer24, width, height);
    const bmpBuffer = Buffer.concat([bmpHeaderBuffer, bmpPixelBuffer]);
  ...
  to16bitBmpBuffer(bgraBuffer, pixelWidth, pixelHeight) {
    ...
    const bmpPixelBuffer = BufferToNormalBmp.reverseBufferLine(bgraBuffer16, width, height);
    const bmpBuffer = Buffer.concat([bmpHeaderBuffer, bmpPixelBuffer]);
